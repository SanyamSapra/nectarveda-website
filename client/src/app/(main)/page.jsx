    ...
    return (
        <main className="min-h-screen bg-slate-50">
            ...
            <section className="relative overflow-hidden bg-linear-to-br from-teal-50 via-white to-emerald-50">
                <motion.div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-28 text-center" {...fadeUp}>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-20">
                <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-2 sm:gap-4 mb-6 sm:mb-10 pb-4 sm:pb-5 border-b border-slate-200">
                    <div>
                ...
                {loading ? (
                    ...
                    <motion.div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 lg:gap-8" variants={staggerContainer} initial="initial" animate="animate">
